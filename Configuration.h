...
#define STRING_CONFIG_H_AUTHOR "(WiNZY, Mini Kossel)" // Who made the changes.
...
#define DEFAULT_DELTA_DIAGONAL_ROD 341 // mm

// Horizontal offset from middle of printer to smooth rod center.
#define DELTA_SMOOTH_ROD_OFFSET 213.5 // mm //158
...
#define Z_PROBE_DEPLOY_START_LOCATION {0, 0, 20, 0}    //{20, 56, 30, 0}   // X, Y, Z, E start location for z-probe deployment sequence
#define Z_PROBE_DEPLOY_END_LOCATION   {5, 56, 30, 0}     //{5, 56, 30, 0} 	  // X, Y, Z, E end location for z-probe deployment sequence
#define Z_PROBE_RETRACT_START_LOCATION   {39, 54, 20, 0} //{39, 54, 20, 0}  // X, Y, Z, E start location for z-probe retract sequence
#define Z_PROBE_RETRACT_END_LOCATION   {0, 0, 40, 0}   //{39, 54, 10, 0}     // X, Y, Z, E end location for z-probe retract sequence 
...
#define MANUAL_Z_HOME_POS 288  // For delta: Distance between nozzle and print surface after homing.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 80, 96.58}
